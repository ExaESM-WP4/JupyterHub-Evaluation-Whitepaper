...
The currently activated default software environment modules are listed, as well as every module available in the \verb|Devel-2019a| stage and \verb|GCC/8.3.0| compiler module hierarchy\footnote{These modules also listed by the \verb|module avail| command in a shell.}.
